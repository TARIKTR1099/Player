...
const Visualizer = ({ analyserRef }) => {
  ...
  useEffect(() => {
    ...
    // Use shared analyser from useAudioPlayer
    ...
    const glowMat = new THREE.MeshBasicMaterial({ color: 0x0f6cbd, transparent: true, opacity: 0.4 });
    ...
    const animate = () => {
      ...
      // Try to get analyser if not available yet (lazy init)
